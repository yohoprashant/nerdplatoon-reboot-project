      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Innovative technology solutions for businesses worldwide. We transform ideas into powerful digital experiences.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-nerd-blue transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-500">
            &copy; {currentYear} NerdPlatoon. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
